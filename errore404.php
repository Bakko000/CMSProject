<!-- Questa è la pagina di errore 404 e viene mostrata quando la pagina non viene trovata attraverso i parametri passati. -->
<!-- La pagina viene anche mostrata in caso di tentativi fraudolenti o sospetti attacchi -->
...
<body>
    ...
    <!-- Questa ampia sezione contiene il necessario per mostrare e animare il trenino. -->
    <div class="main">
        <div>
    ...
    <div class="container">
        <div class="row">
            <p class="error-msg">La pagina che stai cercando non è stata trovata o non hai i permessi per visualizzarla.
            </p>
        </div>
    </div>

    <!-- Questa sezione contiene i bottoni per dirigere l'utente sulla giusta strada mostrandogli dei link utili. -->
    <div class="container">
        <h3 class="perso">Ti sei perso?</h3>
        <div class="colonnalogo404 justify-content-center">
            <a href="javascript:history.back(-1)">
                <img title="Torna un passo indietro" src="./img/outline_undo_black_48dp.png"></img>
            </a>
            <a href="index.php">
                <img title="Torna alla home" src="./img/outline_home_black_48dp.png"></img>
            </a>
            <a href="createblog.php">
                <img title="Scrivi qualcosa in un nuovo blog" src="./img/outline_edit_black_48dp.png"></img>
            </a>
        </div>
    </div>
